...
| polarismesh.cn/customVersion | Define the version information of the instance, It can exist in the metadata.labels or POD's metadata.labels. The priority of Pod is higher than the service |
