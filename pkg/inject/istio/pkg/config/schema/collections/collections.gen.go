...
import (
	"github.com/polarismesh/polaris-controller/pkg/inject/istio/pkg/config/schema/collection"
	"github.com/polarismesh/polaris-controller/pkg/inject/istio/pkg/config/schema/resource"
	"github.com/polarismesh/polaris-controller/pkg/inject/istio/pkg/config/validation"
)
...
var (
	...
	IstioAuthenticationV1Alpha1Meshpolicies = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/authentication/v1alpha1",
			ClusterScoped: true,
	...
	IstioConfigV1Alpha2Httpapispecbindings = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/mixer/v1/config/client",
			ClusterScoped: false,
	...
	IstioMeshV1Alpha1MeshConfig = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/mesh/v1alpha1",
			ClusterScoped: false,
			ValidateProto: validation.EmptyValidate,
		}.MustBuild(),
	}.MustBuild()
	...
	IstioNetworkingV1Alpha3Destinationrules = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/networking/v1alpha3",
			ClusterScoped: false,
	...
	IstioPolicyV1Beta1Attributemanifests = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/policy/v1beta1",
			ClusterScoped: false,
			ValidateProto: validation.EmptyValidate,
		}.MustBuild(),
	}.MustBuild()
	...
	IstioRbacV1Alpha1Clusterrbacconfigs = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/rbac/v1alpha1",
			ClusterScoped: true,
	...
	IstioSecurityV1Beta1Authorizationpolicies = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ProtoPackage:  "github.com/polarismesh/polaris-controller/pkg/inject/api/security/v1beta1",
			ClusterScoped: false,
